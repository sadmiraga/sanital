...
@section('content')
    ...
    <h1 style="text-align: center;margin-top:20vh;">Willkommen</h1>
    ...
    <div class="index-cards">
        <figure class="snip1543">
            ...
            <figcaption>
                ...
                <p>Baureinigung<br>Spezialreinigung<br>Fassadenreinigung<br>Grundreinigung<br>Unterhaltsreinigung<br>Liegenschaftsbetreuunge
                </p>
            </figcaption>
