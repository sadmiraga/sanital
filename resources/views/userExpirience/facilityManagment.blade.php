...
<div class="facility-hero">
    ...
    <div class="facility-content">
        <p>Die Firma Sanical AG besitzt ein grosses Wissen an speziellen Reinigungsverfahren und wendet diese
            praxisorientiert an. Putzen kann jeder, aber Reinigung ist etwas ganz
            anderes</p>
        <br>
        <p>
            Die Branche Facility Management beinhaltet viele Untergruppierungen die wir Ihnen gerne einzeln erklären und
            gerne anbieten:
        </p>

        <h2>Baureinigung: </h2>
        <p>
            Die Baustellen nehmen heutzutage kein Ende, doch für einen sauberen Ablauf und eine strukturierte Übersicht,
